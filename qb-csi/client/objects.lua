...
local function GetClosestcsiObject()
...
RegisterNetEvent('csi:client:spawnCone', function()
    QBCore.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
        ...
        TriggerServerEvent("csi:server:spawnObject", "cone")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
...
RegisterNetEvent('csi:client:spawnBarier', function()
    QBCore.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        ...
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("csi:server:spawnObject", "barier")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        QBCore.Functions.Notify("Canceled..", "error")
    end)
...
RegisterNetEvent('csi:client:spawnSchotten', function()
    QBCore.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        ...
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("csi:server:spawnObject", "schotten")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        QBCore.Functions.Notify("Canceled..", "error")
    end)
...
RegisterNetEvent('csi:client:spawnTent', function()
    QBCore.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        ...
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("csi:server:spawnObject", "tent")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        QBCore.Functions.Notify("Canceled..", "error")
    end)
...
RegisterNetEvent('csi:client:spawnLight', function()
    QBCore.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        ...
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("csi:server:spawnObject", "light")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        QBCore.Functions.Notify("Canceled..", "error")
    end)
...
RegisterNetEvent('csi:client:deleteObject', function()
    local objectId, dist = GetClosestcsiObject()
    if dist < 5.0 then
        QBCore.Functions.Progressbar("remove_object", "Removing object..", 2500, false, true, {
            ...
            TriggerServerEvent("csi:server:deleteObject", objectId)
        end, function() -- Cancel
            StopAnimTask(PlayerPedId(), "weapons@first_person@aim_rng@generic@projectile@thermal_charge@", "plant_floor", 1.0)
            QBCore.Functions.Notify("Canceled..", "error")
        end)
...
RegisterNetEvent('csi:client:removeObject', function(objectId)
    NetworkRequestControlOfEntity(ObjectList[objectId].object)
    DeleteObject(ObjectList[objectId].object)
    ObjectList[objectId] = nil
end)

RegisterNetEvent('csi:client:spawnObject', function(objectId, type, player)
...
RegisterNetEvent('csi:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < SpikeConfig.MaxSpikes then
        if PlayerJob.name == "csi" and PlayerJob.onduty then
            ...
            TriggerServerEvent('csi:server:SyncSpikes', SpawnedSpikes)
        end
    else
...
RegisterNetEvent('csi:client:SyncSpikes', function(table)
    SpawnedSpikes = table
end)
